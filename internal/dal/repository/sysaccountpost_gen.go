...
type defaultSysAccountPostRepository struct {
}

type iDefaultSysAccountPostRepository interface {
	// Create 创建记录（自动失效 FindList / FindPage / Count / Exists 前缀缓存）
	Create(ctx context.Context, m *model.SysAccountPostEntity, opts ...gormplus.CreateOption) error
	CreateTx(ctx context.Context, tx *dao.Query, m *model.SysAccountPostEntity, opts ...gormplus.CreateOption) error
	// CreateBatch 批量创建（自动失效 FindList / FindPage / Count / Exists 前缀缓存）
	CreateBatch(ctx context.Context, m []*model.SysAccountPostEntity, opts ...gormplus.CreateOption) error
	CreateBatchTx(ctx context.Context, tx *dao.Query, m []*model.SysAccountPostEntity, opts ...gormplus.CreateOption) error
	...
	DeleteById(ctx context.Context, sysAccountPostId int64, opts ...gormplus.DeleteOption) error
	DeleteByIdTx(ctx context.Context, tx *dao.Query, sysAccountPostId int64, opts ...gormplus.DeleteOption) error
	// DeleteByIdList 根据ID列表批量删除（自动失效每个 ID 的 FindById，以及 FindList/FindPage/Count/Exists 前缀缓存）
	DeleteByIdList(ctx context.Context, sysAccountPostIds []int64, opts ...gormplus.DeleteOption) error
	DeleteByIdListTx(ctx context.Context, tx *dao.Query, sysAccountPostIds []int64, opts ...gormplus.DeleteOption) error
	...
	DeleteByWrapper(ctx context.Context, fn func(gormplus.IGenWrapper[dao.ISysAccountPostEntityDo]), opts ...gormplus.DeleteOption) error
	DeleteByWrapperTx(ctx context.Context, tx *dao.Query, fn func(gormplus.IGenWrapper[dao.ISysAccountPostEntityDo]), opts ...gormplus.DeleteOption) error
	// UpdateById 根据ID更新指定字段（自动失效该 ID 的 FindById，以及 FindList/FindPage 前缀缓存）
	UpdateById(ctx context.Context, sysAccountPostId int64, opts ...gormplus.UpdateOption) error
	UpdateByIdTx(ctx context.Context, tx *dao.Query, sysAccountPostId int64, opts ...gormplus.UpdateOption) error
	// UpdateMapById 根据ID更新Map数据（自动失效该 ID 的 FindById，以及 FindList/FindPage 前缀缓存）
	UpdateMapById(ctx context.Context, sysAccountPostId int64, data map[string]any) error
	UpdateMapByIdTx(ctx context.Context, tx *dao.Query, sysAccountPostId int64, data map[string]any) error
...
// ==================== 缓存失效辅助方法 ====================
//
// 缓存策略总览（统一以 "sys_account_post.方法名" 为 fnName）：
//
//	写操作              失效范围
//	──────────         ─────────────────────────────────────────────────────────
...
func (r *defaultSysAccountPostRepository) invalidateWriteCaches() {
	gormplus.SFInvalidatePrefixes([]string{
		"sys_account_post.FindList",
		"sys_account_post.FindListByWrapper",
		"sys_account_post.FindPage",
		"sys_account_post.FindPageByWrapper",
		"sys_account_post.FindByIdList",
		"sys_account_post.FindOne",
		"sys_account_post.FindOneWrapper",
		"sys_account_post.Count",
		"sys_account_post.CountByWrapper",
		"sys_account_post.Exists",
		"sys_account_post.ExistsByWrapper",
	})
}

// invalidateAllTableCaches 失效整张表所有缓存（用于条件 Update / Delete，无法预知影响的 ID）。
// 包括 FindById 在内的所有方法都会被清掉。
func (r *defaultSysAccountPostRepository) invalidateAllTableCaches() {
	gormplus.SFInvalidatePrefix("sys_account_post.")
}

// ==================== 公共构建方法 ====================

func (r *defaultSysAccountPostRepository) buildTx(ctx context.Context, query []gormplus.QueryOption) dao.ISysAccountPostEntityDo {
	if len(query) == 0 {
		return dao.SysAccountPostEntity.WithContext(ctx).Order(dao.SysAccountPostEntity.ID.Desc())
	}
	...
	if len(q.Order) > 0 {
		...
		tx = tx.Order(dao.SysAccountPostEntity.ID.Desc())
	}
	if q.Limit != nil {
		tx = tx.Limit(*q.Limit)
	}
...
func (r *defaultSysAccountPostRepository) buildWrapperTx(ctx context.Context, fn func(gormplus.IGenWrapper[dao.ISysAccountPostEntityDo]), query []gormplus.QueryOption) dao.ISysAccountPostEntityDo {
	q := gormplus.MergeQueryOptions(query...)
    ...
    if len(query) > 0 {
        ...
        if len(q.Order) > 0 {
            ...
            entityDo = entityDo.Order(dao.SysAccountPostEntity.ID.Desc())
        }
        if q.Limit != nil {
...
func (r *defaultSysAccountPostRepository) Create(ctx context.Context, m *model.SysAccountPostEntity, opts ...gormplus.CreateOption) error {
...
func (r *defaultSysAccountPostRepository) CreateTx(ctx context.Context, daoTx *dao.Query, m *model.SysAccountPostEntity, opts ...gormplus.CreateOption) error {
	createOpts := gormplus.ResolveCreateOptions(opts)
	tx := daoTx.SysAccountPostEntity.WithContext(ctx)
	if len(createOpts.OmitFields) > 0 {
		tx = tx.Omit(createOpts.OmitFields...)
	}
	if len(createOpts.Clauses) > 0 {
...
func (r *defaultSysAccountPostRepository) CreateBatch(ctx context.Context, m []*model.SysAccountPostEntity, opts ...gormplus.CreateOption) error {
	if len(m) == 0 {
		return nil
	}
	createOpts := gormplus.ResolveCreateOptions(opts)
...
func (r *defaultSysAccountPostRepository) CreateBatchTx(ctx context.Context, daoTx *dao.Query, m []*model.SysAccountPostEntity, opts ...gormplus.CreateOption) error {
	if len(m) == 0 {
		return nil
	}
	createOpts := gormplus.ResolveCreateOptions(opts)
...
func (r *defaultSysAccountPostRepository) DeleteById(ctx context.Context, sysAccountPostId int64, opts ...gormplus.DeleteOption) error {
	...
	_, err := tx.Where(
		dao.SysAccountPostEntity.ID.Eq(sysAccountPostId),
	).Delete()
	if err == nil {
		// 删除：单条精确失效 + 列表/分页前缀失效 + 数量/存在性前缀失效
		gormplus.SFInvalidate("sys_account_post.FindById", gormplus.BuildArgs("id", sysAccountPostId))
		r.invalidateWriteCaches()
	}
	return err
}

func (r *defaultSysAccountPostRepository) DeleteByIdTx(ctx context.Context, daoTx *dao.Query, sysAccountPostId int64, opts ...gormplus.DeleteOption) error {
	deleteOpts := gormplus.ResolveDeleteOptions(opts)
	tx := daoTx.SysAccountPostEntity.WithContext(ctx)
	if deleteOpts.Physical {
		tx = tx.Unscoped()
...
func (r *defaultSysAccountPostRepository) DeleteByIdList(ctx context.Context, sysAccountPostIds []int64, opts ...gormplus.DeleteOption) error {
	...
	_, err := tx.Where(dao.SysAccountPostEntity.ID.In(sysAccountPostIds...)).Delete()
	if err == nil {
		for _, id := range sysAccountPostIds {
			gormplus.SFInvalidate("sys_account_post.FindById", gormplus.BuildArgs("id", id))
		}
		r.invalidateWriteCaches()
	}
	return err
...
func (r *defaultSysAccountPostRepository) DeleteByIdListTx(ctx context.Context, daoTx *dao.Query, sysAccountPostIds []int64, opts ...gormplus.DeleteOption) error {
	if len(sysAccountPostIds) == 0 {
		return nil
	}
	deleteOpts := gormplus.ResolveDeleteOptions(opts)
...
func (r *defaultSysAccountPostRepository) DeleteByCondition(ctx context.Context, cond ...gen.Condition) error {
...
func (r *defaultSysAccountPostRepository) DeleteByConditionTx(ctx context.Context, daoTx *dao.Query, cond ...gen.Condition) error {
	cond, deleteOpts := gormplus.SplitDeleteConditions(cond)
	if len(cond) == 0 {
		return errors.New("删除条件不能为空")
	}
...
func (r *defaultSysAccountPostRepository) DeleteByWrapper(ctx context.Context, fn func(gormplus.IGenWrapper[dao.ISysAccountPostEntityDo]), opts ...gormplus.DeleteOption) error {
	if fn == nil {
		return errors.New("删除条件不能为空")
	}
	deleteOpts := gormplus.ResolveDeleteOptions(opts)
...
func (r *defaultSysAccountPostRepository) DeleteByWrapperTx(ctx context.Context, daoTx *dao.Query, fn func(gormplus.IGenWrapper[dao.ISysAccountPostEntityDo]), opts ...gormplus.DeleteOption) error {
	if fn == nil {
		return errors.New("删除条件不能为空")
	}
	deleteOpts := gormplus.ResolveDeleteOptions(opts)
	baseTx := daoTx.SysAccountPostEntity.WithContext(ctx)
	if deleteOpts.Physical {
		baseTx = baseTx.Unscoped()
	}
	if len(deleteOpts.Clauses) > 0 {
...
func (r *defaultSysAccountPostRepository) UpdateById(ctx context.Context, sysAccountPostId int64, opts ...gormplus.UpdateOption) error {
...
func (r *defaultSysAccountPostRepository) UpdateByIdTx(ctx context.Context, daoTx *dao.Query, sysAccountPostId int64, opts ...gormplus.UpdateOption) error {
	updateOpts := gormplus.ResolveUpdateOptions(opts)
	if len(updateOpts.Columns) == 0 {
		return nil
	}
...
func (r *defaultSysAccountPostRepository) UpdateMapById(ctx context.Context, sysAccountPostId int64, data map[string]any) error {
	if len(data) == 0 {
		return nil
	}
	_, err := dao.SysAccountPostEntity.WithContext(ctx).
		Where(
			dao.SysAccountPostEntity.ID.Eq(sysAccountPostId),
		).
		Updates(data)
...
func (r *defaultSysAccountPostRepository) UpdateMapByIdTx(ctx context.Context, daoTx *dao.Query, sysAccountPostId int64, data map[string]any) error {
	if len(data) == 0 {
		return nil
	}
	_, err := daoTx.SysAccountPostEntity.WithContext(ctx).
		Where(
			dao.SysAccountPostEntity.ID.Eq(sysAccountPostId),
		).
		Updates(data)
...
func (r *defaultSysAccountPostRepository) UpdateByWrapper(ctx context.Context, fn func(gormplus.IGenWrapper[dao.ISysAccountPostEntityDo]), opts ...gormplus.UpdateOption) error {
	if fn == nil {
...
func (r *defaultSysAccountPostRepository) UpdateByWrapperTx(ctx context.Context, daoTx *dao.Query, fn func(gormplus.IGenWrapper[dao.ISysAccountPostEntityDo]), opts ...gormplus.UpdateOption) error {
	if fn == nil {
		return errors.New("更新条件不能为空")
	}
	updateOpts := gormplus.ResolveUpdateOptions(opts)
...
func newDefaultSysAccountPostRepository() *defaultSysAccountPostRepository {
	return &defaultSysAccountPostRepository{}
}

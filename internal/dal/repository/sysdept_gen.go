...
type defaultSysDeptRepository struct {
}

type iDefaultSysDeptRepository interface {
	// Create 创建记录（自动失效 FindList / FindPage / Count / Exists 前缀缓存）
	Create(ctx context.Context, m *model.SysDeptEntity, opts ...gormplus.CreateOption) error
	CreateTx(ctx context.Context, tx *dao.Query, m *model.SysDeptEntity, opts ...gormplus.CreateOption) error
	// CreateBatch 批量创建（自动失效 FindList / FindPage / Count / Exists 前缀缓存）
	CreateBatch(ctx context.Context, m []*model.SysDeptEntity, opts ...gormplus.CreateOption) error
	CreateBatchTx(ctx context.Context, tx *dao.Query, m []*model.SysDeptEntity, opts ...gormplus.CreateOption) error
	...
	DeleteById(ctx context.Context, sysDeptId int64, opts ...gormplus.DeleteOption) error
	DeleteByIdTx(ctx context.Context, tx *dao.Query, sysDeptId int64, opts ...gormplus.DeleteOption) error
	// DeleteByIdList 根据ID列表批量删除（自动失效每个 ID 的 FindById，以及 FindList/FindPage/Count/Exists 前缀缓存）
	DeleteByIdList(ctx context.Context, sysDeptIds []int64, opts ...gormplus.DeleteOption) error
	DeleteByIdListTx(ctx context.Context, tx *dao.Query, sysDeptIds []int64, opts ...gormplus.DeleteOption) error
	...
	DeleteByWrapper(ctx context.Context, fn func(gormplus.IGenWrapper[dao.ISysDeptEntityDo]), opts ...gormplus.DeleteOption) error
	DeleteByWrapperTx(ctx context.Context, tx *dao.Query, fn func(gormplus.IGenWrapper[dao.ISysDeptEntityDo]), opts ...gormplus.DeleteOption) error
	// UpdateById 根据ID更新指定字段（自动失效该 ID 的 FindById，以及 FindList/FindPage 前缀缓存）
	UpdateById(ctx context.Context, sysDeptId int64, opts ...gormplus.UpdateOption) error
	UpdateByIdTx(ctx context.Context, tx *dao.Query, sysDeptId int64, opts ...gormplus.UpdateOption) error
	// UpdateMapById 根据ID更新Map数据（自动失效该 ID 的 FindById，以及 FindList/FindPage 前缀缓存）
	UpdateMapById(ctx context.Context, sysDeptId int64, data map[string]any) error
	UpdateMapByIdTx(ctx context.Context, tx *dao.Query, sysDeptId int64, data map[string]any) error
...
// ==================== 缓存失效辅助方法 ====================
//
// 缓存策略总览（统一以 "sys_dept.方法名" 为 fnName）：
//
//	写操作              失效范围
//	──────────         ─────────────────────────────────────────────────────────
...
func (r *defaultSysDeptRepository) invalidateWriteCaches() {
	gormplus.SFInvalidatePrefixes([]string{
		"sys_dept.FindList",
		"sys_dept.FindListByWrapper",
		"sys_dept.FindPage",
		"sys_dept.FindPageByWrapper",
		"sys_dept.FindByIdList",
		"sys_dept.FindOne",
		"sys_dept.FindOneWrapper",
		"sys_dept.Count",
		"sys_dept.CountByWrapper",
		"sys_dept.Exists",
		"sys_dept.ExistsByWrapper",
	})
}

// invalidateAllTableCaches 失效整张表所有缓存（用于条件 Update / Delete，无法预知影响的 ID）。
// 包括 FindById 在内的所有方法都会被清掉。
func (r *defaultSysDeptRepository) invalidateAllTableCaches() {
	gormplus.SFInvalidatePrefix("sys_dept.")
}

// ==================== 公共构建方法 ====================

func (r *defaultSysDeptRepository) buildTx(ctx context.Context, query []gormplus.QueryOption) dao.ISysDeptEntityDo {
	if len(query) == 0 {
		return dao.SysDeptEntity.WithContext(ctx).Order(dao.SysDeptEntity.ID.Desc())
	}
	...
	if len(q.Order) > 0 {
		...
		tx = tx.Order(dao.SysDeptEntity.ID.Desc())
	}
	if q.Limit != nil {
		tx = tx.Limit(*q.Limit)
	}
...
func (r *defaultSysDeptRepository) buildWrapperTx(ctx context.Context, fn func(gormplus.IGenWrapper[dao.ISysDeptEntityDo]), query []gormplus.QueryOption) dao.ISysDeptEntityDo {
	q := gormplus.MergeQueryOptions(query...)
    ...
    if len(query) > 0 {
        ...
        if len(q.Order) > 0 {
            ...
            entityDo = entityDo.Order(dao.SysDeptEntity.ID.Desc())
        }
        if q.Limit != nil {
...
func (r *defaultSysDeptRepository) Create(ctx context.Context, m *model.SysDeptEntity, opts ...gormplus.CreateOption) error {
...
func (r *defaultSysDeptRepository) CreateTx(ctx context.Context, daoTx *dao.Query, m *model.SysDeptEntity, opts ...gormplus.CreateOption) error {
	createOpts := gormplus.ResolveCreateOptions(opts)
	tx := daoTx.SysDeptEntity.WithContext(ctx)
	if len(createOpts.OmitFields) > 0 {
		tx = tx.Omit(createOpts.OmitFields...)
	}
	if len(createOpts.Clauses) > 0 {
...
func (r *defaultSysDeptRepository) CreateBatch(ctx context.Context, m []*model.SysDeptEntity, opts ...gormplus.CreateOption) error {
	if len(m) == 0 {
		return nil
	}
	createOpts := gormplus.ResolveCreateOptions(opts)
...
func (r *defaultSysDeptRepository) CreateBatchTx(ctx context.Context, daoTx *dao.Query, m []*model.SysDeptEntity, opts ...gormplus.CreateOption) error {
	if len(m) == 0 {
		return nil
	}
	createOpts := gormplus.ResolveCreateOptions(opts)
...
func (r *defaultSysDeptRepository) DeleteById(ctx context.Context, sysDeptId int64, opts ...gormplus.DeleteOption) error {
	...
	_, err := tx.Where(
		dao.SysDeptEntity.ID.Eq(sysDeptId),
	).Delete()
	if err == nil {
		// 删除：单条精确失效 + 列表/分页前缀失效 + 数量/存在性前缀失效
		gormplus.SFInvalidate("sys_dept.FindById", gormplus.BuildArgs("id", sysDeptId))
		r.invalidateWriteCaches()
	}
	return err
}

func (r *defaultSysDeptRepository) DeleteByIdTx(ctx context.Context, daoTx *dao.Query, sysDeptId int64, opts ...gormplus.DeleteOption) error {
	deleteOpts := gormplus.ResolveDeleteOptions(opts)
	tx := daoTx.SysDeptEntity.WithContext(ctx)
	if deleteOpts.Physical {
		tx = tx.Unscoped()
...
func (r *defaultSysDeptRepository) DeleteByIdList(ctx context.Context, sysDeptIds []int64, opts ...gormplus.DeleteOption) error {
	if len(sysDeptIds) == 0 {
		return nil
	}
	deleteOpts := gormplus.ResolveDeleteOptions(opts)
	...
	_, err := tx.Where(dao.SysDeptEntity.ID.In(sysDeptIds...)).Delete()
	if err == nil {
		for _, id := range sysDeptIds {
			gormplus.SFInvalidate("sys_dept.FindById", gormplus.BuildArgs("id", id))
		}
		r.invalidateWriteCaches()
	}
	return err
...
func (r *defaultSysDeptRepository) DeleteByIdListTx(ctx context.Context, daoTx *dao.Query, sysDeptIds []int64, opts ...gormplus.DeleteOption) error {
	if len(sysDeptIds) == 0 {
		return nil
	}
	deleteOpts := gormplus.ResolveDeleteOptions(opts)
...
func (r *defaultSysDeptRepository) DeleteByCondition(ctx context.Context, cond ...gen.Condition) error {
...
func (r *defaultSysDeptRepository) DeleteByConditionTx(ctx context.Context, daoTx *dao.Query, cond ...gen.Condition) error {
	cond, deleteOpts := gormplus.SplitDeleteConditions(cond)
	if len(cond) == 0 {
		return errors.New("删除条件不能为空")
	}
...
func (r *defaultSysDeptRepository) DeleteByWrapper(ctx context.Context, fn func(gormplus.IGenWrapper[dao.ISysDeptEntityDo]), opts ...gormplus.DeleteOption) error {
	if fn == nil {
		return errors.New("删除条件不能为空")
	}
	deleteOpts := gormplus.ResolveDeleteOptions(opts)
...
func (r *defaultSysDeptRepository) DeleteByWrapperTx(ctx context.Context, daoTx *dao.Query, fn func(gormplus.IGenWrapper[dao.ISysDeptEntityDo]), opts ...gormplus.DeleteOption) error {
	if fn == nil {
		return errors.New("删除条件不能为空")
	}
	deleteOpts := gormplus.ResolveDeleteOptions(opts)
	baseTx := daoTx.SysDeptEntity.WithContext(ctx)
	if deleteOpts.Physical {
		baseTx = baseTx.Unscoped()
	}
	if len(deleteOpts.Clauses) > 0 {
...
func (r *defaultSysDeptRepository) UpdateById(ctx context.Context, sysDeptId int64, opts ...gormplus.UpdateOption) error {
...
func (r *defaultSysDeptRepository) UpdateByIdTx(ctx context.Context, daoTx *dao.Query, sysDeptId int64, opts ...gormplus.UpdateOption) error {
	updateOpts := gormplus.ResolveUpdateOptions(opts)
	if len(updateOpts.Columns) == 0 {
		return nil
	}
...
func (r *defaultSysDeptRepository) UpdateMapById(ctx context.Context, sysDeptId int64, data map[string]any) error {
	if len(data) == 0 {
		return nil
	}
	_, err := dao.SysDeptEntity.WithContext(ctx).
		Where(
			dao.SysDeptEntity.ID.Eq(sysDeptId),
		).
		Updates(data)
...
func (r *defaultSysDeptRepository) UpdateMapByIdTx(ctx context.Context, daoTx *dao.Query, sysDeptId int64, data map[string]any) error {
	if len(data) == 0 {
		return nil
	}
	_, err := daoTx.SysDeptEntity.WithContext(ctx).
		Where(
			dao.SysDeptEntity.ID.Eq(sysDeptId),
		).
		Updates(data)
...
func (r *defaultSysDeptRepository) UpdateByWrapper(ctx context.Context, fn func(gormplus.IGenWrapper[dao.ISysDeptEntityDo]), opts ...gormplus.UpdateOption) error {
	if fn == nil {
...
func (r *defaultSysDeptRepository) UpdateByWrapperTx(ctx context.Context, daoTx *dao.Query, fn func(gormplus.IGenWrapper[dao.ISysDeptEntityDo]), opts ...gormplus.UpdateOption) error {
	if fn == nil {
		return errors.New("更新条件不能为空")
	}
	updateOpts := gormplus.ResolveUpdateOptions(opts)
...
func newDefaultSysDeptRepository() *defaultSysDeptRepository {
	return &defaultSysDeptRepository{}
}
